...
let val = ''
export class SameGenderTwin extends React.Component {
    ...
    getData = async () => {
        let query = `{
            Compare834FileDetailsMismatch(FileName:"${this.state.selected_FileID}",Mismatch:"samegendertwin") {
              memid
              enrollid
              SubscriberNo
              FirstName
    ...
    render() {
        return (
            <div>
                <h5 className="headerText">Same Gender Twin</h5>
