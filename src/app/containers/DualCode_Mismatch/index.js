...
let val = ''
export class DualCodeMismatch extends React.Component {
    ...
    getData = async () => {
        let query = `{
            Compare834FileDetailsMismatch(FileName:"${this.state.selected_FileID}",Mismatch:"Dual Code") {
              memid
              enrollid
              SubscriberNo
              FirstName
    ...
    _renderTransactions() {
        let columnDefs = [
            ...
            { headerName: "X12COB Carrier Policy Id", field: "x12COBCarrierPolicyId", width: 130, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal', color: '#139DC9', cursor: 'pointer' }, pinned: 'left' },
            { headerName: "Carrier Name", field: "CarrierID", width: 130, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal', color: '#139DC9', cursor: 'pointer' }, pinned: 'left' },
            ...
            { headerName: "X12 Street Address", field: "x12StreetAddress", width: 180, },
            ...
            { headerName: "QNXT State", field: "State", width: 100,  },
    ...
    render() {
        return (
            <div>
                <h5 className="headerText">Dual Code Mismatch</h5>
