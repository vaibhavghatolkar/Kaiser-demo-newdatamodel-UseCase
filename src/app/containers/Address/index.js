...
let val = ''
export class AddressMismatch extends React.Component {
    ...
    getData = async () => {
        let query = `{
            Compare834FileDetailsMismatch(FileName:"${this.state.selected_FileID}",Mismatch:"address") {
              memid
              enrollid
              SubscriberNo
              FirstName
    ...
    render() {
        return (
            <div>
                <h5 className="headerText">Address Mismatch Delta</h5>
