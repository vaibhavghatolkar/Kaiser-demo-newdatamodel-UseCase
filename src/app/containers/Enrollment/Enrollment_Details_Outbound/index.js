...
const $ = window.$;
export class Enrollment_Details_Outbound extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            Status_Enrollment:props.location.state && props.location.state.data[0] && props.location.state.data[0].status ? props.location.state.data[0].status : '',
            maintenance_Code: props.location.state && props.location.state.data[0] && props.location.state.data[0].MaintenanceCode ? props.location.state.data[0].MaintenanceCode : '',
            ...
            Enrollment_Status:props.location.state && props.location.state.data[0] && props.location.state.data[0].EnrollmentStatus ? props.location.state.data[0].EnrollmentStatus : '',
            dob:'',
            defaultColDef: {
    ...
    getData() {
        ...
        let query = `{Dashboard834FileDetailsOutbound(State:"${this.state.State}",StartDt:"${startDate}",EndDt:"${endDate}", RecType:"Outbound", Status:"${this.state.Status_Enrollment}",FileID:"${this.state.incoming_FileID}",MaintenanceCode:"${this.state.maintenance_Code}",ErollmentErrStatus:"${this.state.Enrollment_Status}") {
            FileName
            Date
            Subscriber
            Enrollment
        ...
        fetch(Urls._transaction834, {
            ...
            .then(r => {
                let data = []
                data = r.data.Dashboard834FileDetailsOutbound
    ...
    onClick(fileId) {
        ...
        let query = `{ProcessingSummary834(State:"${this.state.State}",StartDt:"${startDate}",EndDt:"${endDate}",FileID:"${fileId}",Status:"${this.state.Enrollment_Status}", RecType:"Outbound", MaintenanceCode:"${this.state.maintenance_Code}")  {
