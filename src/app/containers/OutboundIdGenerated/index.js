    ...
    getListData = () => {
        ...
        fetch(Urls._transaction834, {
            ...
            .then(res => {
                ...
                this.setState({
                    rowData: res.data.OutboundFileDetails,
...
<div className="col-3"> 16</div>
    ...
    _getCounts = async () => {
        ...
        fetch(Urls._transaction834, {
            ...
            .then(res => {
                let summary = []
                let data = res.data.OutboundFileCount[0]


                summary = [
                    { name: 'VSP Status', value: data.VSPStatus },
                    { name: 'Beacon Status', value: data.BeaconStatus },
                    { name: 'PerRxMMStatus', value: data.perRXMMStatus },
                    { name: 'Errors', value: 0 },
                ]
  ...
  ResubmitCount
    ...
    _getPieChartData = async () => {
        ...
        fetch(Urls._transaction834, {
            ...
            .then(res => {
                console.log(res)
                let second_data = res.data.AggrPieChart834 && res.data.AggrPieChart834.length > 0 ? this.getPieChartData(res.data.AggrPieChart834) : ''
                this.setState({
            ...
            <div className="chart-div">
                <div className="row">
                    <div className="col-8" style={{ padding: '6px' }}>
                        {this.renderPieChart('', this.state.second_data)}
                    </div>
    ...
    _renderList = () => {
        let columnDefs = [
            ...
            { headerName: "HMS", field: "HMS", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            { headerName: "Questlab Medicaid", field: "Questlab_Medicaid", width: 150, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            { headerName: "Marchvision", field: "Marchvision", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            { headerName: "logisticare", field: "logisticare", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            { headerName: "rxAmerica", field: "rxAmerica", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            // { headerName: "BeaconStatus", field: "BeaconStatus", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal', color: '#139DC9', cursor: 'pointer' } },
            // { headerName: "VSPStatus", field: "VSPStatus", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            // { headerName: "perRxMMStatus", field: "perRXMMStatus", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            // { headerName: "perRxMCStatus", field: "", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
        ]
