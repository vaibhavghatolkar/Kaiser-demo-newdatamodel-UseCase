...
let val = ''
export class Duplicate extends React.Component {
    ...
    getData = async () => {
        let query = `{
            Compare834FileDetailsMismatch(FileName:"${this.state.selected_FileID}",Mismatch:"duplicate") {
              memid
              enrollid
              SubscriberNo
              FirstName
    ...
    render() {
        return (
            <div>
                <h5 className="headerText">Duplicate in File</h5>
