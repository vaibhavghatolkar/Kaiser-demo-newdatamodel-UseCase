        ...
        data.forEach((d) => {
            ...
            row.push(
                <tr>
                    ...
                    <td>{FullName}</td>
                    <td><img src={require('../../components/Images/pencil.png')} onClick={this.displayUser} data-value={d.Id} data-toggle="modal" data-target="#myModal2" style={{width: '20px'}}></img></td>
    ...
    UserList() {
        return (
            <div>
                ...
                <div className="row">
                    <h5  style={{ color: '#139DC9', padding: '20px' }}>User List</h5>
                            ...
                            <div class="modal-body">
                                <div className="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input onChange={(e) => this.onHandleChange(e, 'firstName')} type="text" className="form-control" name="firstName" id="FirstName"
                                            placeholder="Enter First Name" />
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="LastName">Last Name</label>
                                        <input onChange={(e) => this.onHandleChange(e, 'lastName')} name="lastName" type="text" className="form-control" id="LastName"
                                ...
                                <div class="form-group">
                                    ...
                                    <input onChange={(e) => this.onHandleChange(e, 'email')} name="email" type="text" className="form-control" id="Email"
                                ...
                                <div class="form-group">
                                    ...
                                    <input onChange={(e) => this.onHandleChange(e, 'phoneNo')} name="phoneNo" type="text" className="form-control" id="phoneno"
                                        placeholder="Enter Phone Number" />
                                </div>
                                <div class="form-group">
                                    <label for="UserRole">User Role</label>
                                    <select className="form-control" name="userRole" onChange={(e) => this.onHandleChange(e, 'userRole')}>
