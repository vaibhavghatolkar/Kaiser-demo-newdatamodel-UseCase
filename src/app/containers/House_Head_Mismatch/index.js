...
let val = ''
export class House_Head_Mismatch extends React.Component {
    ...
    getData = async () => {
        let query = `{
            Compare834FileDetailsMismatch(FileName:"${this.state.selected_FileID}",Mismatch:"household") {
              memid
              enrollid
              SubscriberNo
              FirstName
    ...
    _renderTransactions() {
        let columnDefs = [
            ...
            { headerName: "QNXT Headofhouse", field: "qnxtHeadofhouse", width: 120, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            { headerName: "X12 Headofhouse", field: "x12Headofhouse", width: 120, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
    ...
    render() {
        return (
            <div>
                <h5 className="headerText">Household Mismatch</h5>
