...
let val = ''
export class GenderMismatch extends React.Component {
    ...
    getData = async () => {
        let query = `{
            Compare834FileDetailsMismatch(FileName:"${this.state.selected_FileID}",Mismatch:"gender") {
              memid
              enrollid
              SubscriberNo
              FirstName
    ...
    render() {
        return (
            <div>
                <h5 className="headerText">Gender Mismatch Delta</h5>
