...
let val = ''
export class MMRFileLoad extends React.Component {
    ...
    getListData = () => {
        ...
        fetch('http://10.0.1.248:30542/mmrdetails', {
            ...
            .then(res => res.json())
            .then(res => {
                if (res && res.data && res.data.MMRFileDetails) {

                    this.setState({
                        claimsList: res.data.MMRFileDetails,
                        rowData: this.state.gridType == 1 ? res.data.MMRFileDetails : [],
                        count: 0
                    })
                }
            })
    ...
    _getCounts = async () => {
        ...
        fetch(Urls._Payment820, {
            ...
            .then(res => {
                ...
                summary = [
                    { name: 'Total Files', value: '2' },
                    { name: 'Total Remittance Amount', value: '626692540.41', isAmount : true},
                ]
    ...
    _renderSummaryDetails = () => {
        ...
        array.forEach(item => {
            ...
            row.push(
                ...
                url={url ? url : Strings.MMRFileLoadDetails}
                />
    ...
    renderClaimDetails = () => {
        ...
        let stage_1 = [
            ...
            { 'name': 'MMR File Count', 'value': 10240 },
            { 'name': 'HiPaaS Count ', 'value': 10240 },
    ...
    gotoClaimDetails = (data) => {
        ...
        this.props.history.push('/' + Strings.MMRFileLoadDetails, {
            data: sendData
        })
    }
    progressBar() {
    ...
    render() {
        ...
        return (
            <div>
                <h5 className="headerText">MMR File Load</h5>
