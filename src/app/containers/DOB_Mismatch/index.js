...
let val = ''
export class DobMismatch extends React.Component {
    ...
    getData = async () => {
        let query = `{
            Compare834FileDetailsMismatch(FileName:"${this.state.selected_FileID}",Mismatch:"dob") {
              memid
              enrollid
              SubscriberNo
              FirstName
    ...
    render() {
        return (
            <div>
                <h5 className="headerText">Dob Mismatch Delta</h5>
