...
<div className="col-3"> 16</div>
  ...
  ResubmitCount
    ...
    _renderList = () => {
        let columnDefs = [
            { headerName: "Subscriber No", field: "SubscriberNo", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            { headerName: "Enrollment Id", field: "enrollid", flex: 1, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
