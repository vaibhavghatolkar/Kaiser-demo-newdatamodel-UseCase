...
let val = ''
export class Effective_date_Mismatch extends React.Component {
    ...
    getData = async () => {
        let query = `{
            Compare834FileDetailsMismatch(FileName:"${this.state.selected_FileID}",Mismatch:"eff date") {
              memid
              enrollid
              SubscriberNo
              FirstName
    ...
    _renderTransactions() {
        let columnDefs = [
            ...
            { headerName: "QNXT Effective Date", field: "Qeffdate", width: 120, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
            { headerName: "X12 Effective Date", field: "filestartdate", width: 120, cellStyle: { wordBreak: 'break-all', 'white-space': 'normal' } },
    ...
    render() {
        return (
            <div>
                <h5 className="headerText">Effective Date Mismatch</h5>
