...
export class Outbound_Claim_updated_Payment extends React.Component {
        ...
        fetch(Urls._Encounter, {
            ...
            .then(res => {
                ...
                let summary = [
                    ...
                    { name: 'Denied', value: condition ? data[0].Denied : 0 , color: '#F39C12'},
                    // { name: 'Payment Never Submitted', value: condition ? data[0].Payment_Never_Submitted : 0 },
                    { name: 'Payment Adjustment', value: condition ? data[0].Payment_Adjustment : 0, color: '#1DA3CD' },
    ...
    render_Outbound_ClaimDetails = () => {
        ...
        let stage_1 = [
            { header: '', },
            { 'name': 'Corrected Patient/Insured Name', 'value': 55, 'isClick': true },
            { 'name': 'Corrected Priority Payer Name', 'value': 60, 'isClick': true },
            { 'name': 'Corrected ICD Code', 'value': 40, 'isClick': true },
       ]
