...
export class ClaimCustomerService extends React.Component {
    ...
    _renderClaims() {
        let columnDefs = [
            ...
            { headerName: "Batch Name", field: "BatchName", width:140, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            { headerName: "Batch Date", field: "BatchDate", width:100, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            { headerName: "Batch Claim Status", field: "BatchClaimStatus", width:100, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            { headerName: "FileName Sent To State", field: "FileName_Outbound", width:100, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            { headerName: "FileDate Sent To State", field: "FileDate_Outbound", width:100, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            { headerName: "File Status Sent To State", field: "FileStatus_Outbound", width:100, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            // { headerName: "Payment Status", field: "PaymentStatus", width:100, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            { headerName: "999 Status", field: "Encounter99_Status", width:100, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            { headerName: "277CA Status", field: "Encounter277CA_Status", width:100, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            { headerName: "Payment Status", field: "PaymentStatus", width:150, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            // { headerName: "999", field: "F999", width:150, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
            // { headerName: "277CA", field: "F277CA", width:150, cellStyle: {wordBreak: 'break-all',   'white-space': 'normal' } },
