...
export class EncounterDashboard_New extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columnDefs: [
                ...
                { headerName: "ODS Load Status", field: "MCGStatus", width: 100 },
    ...
    renderClaimDetails = () => {
        ...
        let stage_3 = [
            ...
            // { 'name': 'Load in QNXT', 'value': this.state.LoadingClaims, 'isClick': 1 },
    ...
    render() {
        return (
            <div>
                ...
                {this._renderTopbar()}
                {/* {this.tab()} */}
                <div className="general-header" style={{ marginBottom: "-6px" }}>Encounter File Status</div>
                {this._renderSummaryDetails()}
                <div className="general-header">Encounter Status</div>
