...
var val = ''
const $ = window.$;
export class Encounter_Load_Exception extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columnDefs: [
                ...
                { headerName: "Total Encounters", field: "Claimcount", width: 80 },
            ],
    ...
    render() {
        ...
        return (
            <div>
                <h5 className="headerText">Encounter Load Exception</h5>
                {this._renderTopbar()}
                {
                    this.state.gridType
                        ?
